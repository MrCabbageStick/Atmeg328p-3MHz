...
`unit_scale` will probably be read as: 10<sup>-unit_scale</sup>*unit*, where *unit* represents unit for the given `sensor_type`. So if we wanted to represent hundredth part of the °C, `unit_scale` would have a value of `2` (`0b10`).
